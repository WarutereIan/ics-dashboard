...
const vacisKeSubActivities: Record<string, SubActivity[]> = {
  'vaciske-activity-1.1': [
    ...
    { id: 'vaciske-activity-1.1.2', title: 'Adapt program materials', progress: 60, status: 'in-progress', description: 'Customize materials for local context', dueDate: '2024-06-01' },
  ],
  'vaciske-activity-1.2': [
    { id: 'vaciske-activity-1.2.1', title: 'Identify new locations', progress: 80, status: 'in-progress', description: 'Survey and select new program sites', dueDate: '2024-05-01' },
    { id: 'vaciske-activity-1.2.2', title: 'Train facilitators', progress: 30, status: 'not-started', description: 'Facilitator training for new locations', dueDate: '2024-07-01' },
  ],
  'vaciske-activity-2.1': [
    { id: 'vaciske-activity-2.1.1', title: 'Document best practices', progress: 50, status: 'in-progress', description: 'Compile and document effective practices', dueDate: '2024-08-01' },
  ],
};
...
export const vacisKeOutcomes: Outcome[] = [
  ...
  { id: 'vaciske-outcome-2', projectId: 'vacis-ke', title: 'Policies and evidence-based models and practices to address violence in and around schools adapted by education stakeholders in government and CSOs', description: '', target: undefined as any, current: undefined as any, unit: '', progress: 0, status: 'on-track' },
  { id: 'vaciske-outcome-3', projectId: 'vacis-ke', title: 'Social and gender norms that perpetuate violence against children and young women identified and shifted in Kenya (I ward Kisumu)', description: '', target: undefined as any, current: undefined as any, unit: '', progress: 0, status: 'on-track' },
  { id: 'vaciske-outcome-4', projectId: 'vacis-ke', title: 'ICS SP organizational capacity is strengthened to facilitate mission driven actions.', description: '', target: undefined as any, current: undefined as any, unit: '', progress: 0, status: 'on-track' },
];

export const vacisKeActivities: Activity[] = [
  // Outcome 1 Activities
  { id: 'vaciske-activity-1.1', outcomeId: 'vaciske-outcome-1', title: 'Adapting and scaling evidence-based parenting programmes through government systems.', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: vacisKeSubActivities['vaciske-activity-1.1'] },
  { id: 'vaciske-activity-1.2', outcomeId: 'vaciske-outcome-1', title: 'Geographical expansion of gender transformative parenting programmes in new locations in Kenya.', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: vacisKeSubActivities['vaciske-activity-1.2'] },
  ...
  { id: 'vaciske-activity-2.1', outcomeId: 'vaciske-outcome-2', title: 'Evidence generated and practice knowledge documented and utilised to strengthen whole school approach and to influence education sector plans and programmes', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: vacisKeSubActivities['vaciske-activity-2.1'] },
  { id: 'vaciske-activity-2.2', outcomeId: 'vaciske-outcome-2', title: 'Geographical expansion of the adapted WSA to new schools in Kenya', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: [] },
  { id: 'vaciske-activity-2.3', outcomeId: 'vaciske-outcome-2', title: 'Safe, healthy and equitable families', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: [] },
  { id: 'vaciske-activity-2.4', outcomeId: 'vaciske-outcome-2', title: 'Safe and inclusive learning environments', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: [] },
  // Outcome 3 Activities
  { id: 'vaciske-activity-3.1', outcomeId: 'vaciske-outcome-3', title: 'Pilot test Fanikisha Uajibikaji Nyanjani (FUN) intervention in the period 2024-2026', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: [] },
  { id: 'vaciske-activity-3.2', outcomeId: 'vaciske-outcome-3', title: 'Facilitate the social and economic inclusion of girls aged 14-24 years who are at high risk of VAC/W.', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: [] },
  ...
  { id: 'vaciske-activity-3.5', outcomeId: 'vaciske-outcome-3', title: 'Mobilize and organize public involvement and participation of stakeholders in improving public service systems', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: [] },
  { id: 'vaciske-activity-3.6', outcomeId: 'vaciske-outcome-3', title: 'Forming and or participating in existing policy networks and social movements on ending violence against children and women.', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: [] },
  // Outcome 4 Activities
  { id: 'vaciske-activity-4.1', outcomeId: 'vaciske-outcome-4', title: 'Talent management and retention', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: [] },
  { id: 'vaciske-activity-4.2', outcomeId: 'vaciske-outcome-4', title: 'Systems procurement and upgrade (M&E)', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: [] },
  { id: 'vaciske-activity-4.3', outcomeId: 'vaciske-outcome-4', title: 'Business development and fundraising', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: [] },
  { id: 'vaciske-activity-4.4', outcomeId: 'vaciske-outcome-4', title: 'Equipment and logistical assets (transportation)', description: '', progress: 0, status: 'not-started', startDate: undefined as any, endDate: undefined as any, responsible: '', subActivities: [] },
];

export const vacisKeOutputs: Output[] = [
  // Outcome 1 Outputs
  { id: 'vaciske-output-1.1', outcomeId: 'vaciske-outcome-1', title: 'Increased capacity of the government to develop and implement VAC/W prevention', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  { id: 'vaciske-output-1.2', outcomeId: 'vaciske-outcome-1', title: 'Increased budgetary allocation to VAC/W prevention programs', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  { id: 'vaciske-output-1.3', outcomeId: 'vaciske-outcome-1', title: 'Increased capacity of partners (government & CSOs paraprofessionals) to deliver gender transformative parenting', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  { id: 'vaciske-output-1.4', outcomeId: 'vaciske-outcome-1', title: 'Baseline and endline research conducted to demonstrate the effectiveness of gender transformative parenting programmes in addressing VAC/W', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  // Outcome 2 Outputs
  { id: 'vaciske-output-2.1', outcomeId: 'vaciske-outcome-2', title: 'Teachers equipped with knowledge and skills to address contemporary education challenges to meet unique needs of school', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  { id: 'vaciske-output-2.2', outcomeId: 'vaciske-outcome-2', title: 'Increased commitment to parental engagement in education to promote learning outcomes in schools', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  { id: 'vaciske-output-2.3', outcomeId: 'vaciske-outcome-2', title: 'Increased capacity by the government and education sector CSOs to incorporate VAC prevention and response strategies in their programs', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  // Outcome 3 Outputs
  { id: 'vaciske-output-3.1', outcomeId: 'vaciske-outcome-3', title: 'Community beliefs, norms and value systems that prevent VAC are strengthened', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  { id: 'vaciske-output-3.2', outcomeId: 'vaciske-outcome-3', title: 'Integration of the social norms change model into government and CSOs programs', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  { id: 'vaciske-output-3.3', outcomeId: 'vaciske-outcome-3', title: 'Increased empowerment and agency among AGYWs in making informed choices on their health and wellbeing', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  { id: 'vaciske-output-3.4', outcomeId: 'vaciske-outcome-3', title: 'Increased survivor-led advocacy initiatives to influence policies addressing VAC/W', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  // Outcome 4 Outputs
  { id: 'vaciske-output-4.1', outcomeId: 'vaciske-outcome-4', title: 'Increased capacity to develop and scale innovative VAC/W prevention solutions', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
  { id: 'vaciske-output-4.2', outcomeId: 'vaciske-outcome-4', title: 'Enhanced operational efficiency and organizational sustainability', description: '', current: 0, target: 0, unit: '', status: 'on-track', activities: [] },
];
