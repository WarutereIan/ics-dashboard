    ...
    <Card className="mt-4 border-l-4 border-l-blue-500">
      ...
      <CardContent>
        ...
        <div className="mb-4 p-3 bg-emerald-50 rounded-lg">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-emerald-900">Average Contribution</span>
            <span className="text-lg font-bold text-emerald-900">{averageContribution}%</span>
          </div>
