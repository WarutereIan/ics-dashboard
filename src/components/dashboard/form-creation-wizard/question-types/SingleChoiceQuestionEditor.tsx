...
export function SingleChoiceQuestionEditor(props: SingleChoiceQuestionEditorProps) {
  ...
  console.log('🔍 Options detection debug:', {
  ...
  console.log('🔍 Safe options result:', {
  ...
  useEffect(() => {
    ...
    if (!hasOptionsInAnyLocation) {
      console.log('🎨 SingleChoiceQuestionEditor: No options found, initializing with defaults');
      onUpdate({
        options: safeOptions
      } as Partial<FormQuestion>);
    } else {
      console.log('🎨 SingleChoiceQuestionEditor: Options found, preserving existing options');
    }
